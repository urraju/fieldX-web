    ...
    return(
        <div className="mt-96 my-20 max-w-[1400px] mx-auto">
             ...
             <div className="max-w-screen-xl flex flex-col md:flex-row  justify-center mx-auto">
                    ...
                    <div className="mb-10">
                        <img className="w-12 h-12  ml-[284px] bg-white shadow border p-2 rounded-xl" src="/src/assets/All_img/box.png" alt="" />
                    ...
                    <div className="mb-10">
                        <img className="w-12 h-12 bg-white  ml-[284px] shadow border p-2 rounded-xl" src="/src/assets/All_img/box.png" alt="" />
                    ...
                    <div className="relative flex-grow ">
                        <img className="image_shadow w-72 mx-auto rounded-3xl object-contain" src="/src/assets/All_img/Central phone 2.png" alt="" />
                    ...
                    <div className="mb-10">
                        <img className="w-12 h-12 bg-white shadow border p-2 rounded-xl" src="/src/assets/All_img/box.png" alt="" />
